...
export const metadata: Metadata = {
  title: "Privacy Policy - The Owner's Index",
}
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          The Owner&apos;s Index (&ldquo;the Index&rdquo;) is operated by Ashton Jones. The Owner&apos;s Index is a diagnostic tool that measures how dependent a business is on its owner across five dimensions: Process, Information, Decision, Energy and Taste. If you have questions about this policy or your data, contact us at{' '}
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>Your responses to the Owner&apos;s Index diagnostic and your computed dependency scores (Founder Dependency Score, Process Dependency, Information Dependency, Decision Dependency, Energy Dependency and Watermark Strength)</li>
          <li>Full chat session transcripts - the complete word-for-word conversation from every session</li>
          <li>Session summaries including the Owner&apos;s Playbook pillars explored, key tensions identified, practical actions taken and shifts observed</li>
    ...
    content: (
      <>
        ...
        <p style={{ marginBottom: '10px' }}>
          <strong style={{ color: '#334a69' }}>Coaching.</strong> Your diagnostic results, dependency scores, conversation history and session summaries enable the Index to deliver personalised coaching on business extraction - helping you reduce reliance on yourself and build a business that can operate without you. This data allows the Index to build on previous sessions and track your progress over time.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p style={{ marginBottom: '10px' }}>
          <strong style={{ color: '#334a69' }}>After deletion:</strong> when your account is deleted, all personal data including your name, email, diagnostic responses, dependency scores, chat transcripts and session summaries is permanently deleted within 30 days.
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>The storage of your diagnostic scores and full session transcripts for coaching continuity</li>
  ...
  },
  {
    ...
    content: (
      <p>
        In the event of a data breach that affects your personal data, we will notify you by email within 48 hours. Where required by applicable law, we will report the breach to the relevant supervisory authority within 72 hours.
      </p>
    ),
  },
  {
